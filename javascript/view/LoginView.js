class LoginView
{
  static display()
  {
    ...
    HTML += '<h1 class="text-center">CLOUD</h1>';

    HTML += `<form id="login_form" action="action/ajaxRequest.php" method="post" onsubmit="return ajaxSubmit('action/ajaxRequest.php', 'login_form');"></form>
